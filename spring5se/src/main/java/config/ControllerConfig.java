...
public class ControllerConfig {
	...
	public ChangePwdController changePwdController() {
			ChangePwdController con = new ChangePwdController();
			con.setChangePasswordService(changepasswordservice);
			return con;
	}
	@Bean
	public MemberListController memberListController() {
		MemberListController mem = new MemberListController();
		mem.setMemberDao(memberDao);
		return mem;
	}
	@Bean
